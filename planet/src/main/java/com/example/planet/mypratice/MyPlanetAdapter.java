 ...
 * description: 类的描述
 */
public abstract class MyPlanetAdapter {

    /**
     * 数据改变监听
     */
    private PlanetAdapter.OnDataSetChangeListener onDataSetChangeListener;
     ...
     */
    public void setOnDataSetChangeListener(PlanetAdapter.OnDataSetChangeListener listener) {
