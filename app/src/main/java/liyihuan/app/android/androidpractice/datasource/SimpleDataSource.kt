 ...
 * description: 类的描述
 */
class SimpleDataSource<R>(cacheProvide: LocalCacheProvide<R>? = null, requestType: RequestType? = RequestType.OnlyRemote, private var remoteQuest: () -> Observable<R>) : AbsDataSource<R>(cacheProvide, requestType) {
