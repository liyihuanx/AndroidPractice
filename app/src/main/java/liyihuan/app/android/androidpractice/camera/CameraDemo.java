...
public class CameraDemo extends AppCompatActivity {
    ...
    private static final String FILE_PROVIDER_AUTHORITY = "liyihuan.app.android.androidpractice.fileprovider";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTakePhoto = (Button) findViewById(R.id.btn_Camera);
        mChooseFromAlbum = (Button) findViewById(R.id.btn_Album);
